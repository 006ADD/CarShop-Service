...
public class PSQLContainer {
    ...
    public void setUp() {
        ...
        try (Connection connection = DriverManager.getConnection(
            ...
            e.printStackTrace();
            assertTrue(false, "Error when creating tables: " + e.getMessage());
        }
    }
    ...
    public void testDatabaseOperation() {
        try (Connection connection = DriverManager.getConnection(
            ...
            assertTrue(resultSet.getString("name").equals("Test Name"));
        } catch (SQLException e) {
            e.printStackTrace();
            assertTrue(false, "Error when running test: " + e.getMessage());
        }
    }
